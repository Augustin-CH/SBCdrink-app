  ...
  return (
        <div className="container-glass-loader">
            <svg viewBox="0 0 512 512" className="le-svg">
                <defs>
                    <path id="liquid_full" className="yellow" d="M313.8,159.7h-116c-4.6,0-8.4,3.7-8.4,8.4l13.1,180c0,4.6,3.7,8.4,8.4,8.4h87.2c4.6,0,8.4-3.7,8.4-8.4l15.7-180C322.2,163.4,318.5,159.7,313.8,159.7z"/>
                </defs>
                ...
                <g id="glass_out">
                    <path className="glass" d="M313.3,367.7h-116c-3,0-5.4-2.4-5.4-5.4L173,149.7c0-3,2.4-5.4,5.4-5.4h155.2c3,0,5.4,2.4,5.4,5.4l-20.2,212.5C318.8,365.3,316.3,367.7,313.3,367.7z"/>
